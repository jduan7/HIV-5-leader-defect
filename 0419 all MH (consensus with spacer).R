...
all_MH<-tibble(Mid,Mseqname,Mdelstart,Mdelend,Mlen,Mdir,Mseq,M_hxb2delstart,M_hxb2delend,M_dlen)      

write_xlsx(all_MH,"C:\\Users\\jduan\\5PSD_master_041922_tilda_uniq_consensus_WithSpacer_allMH.xlsx")
